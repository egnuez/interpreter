...
namespace lsbasi {
	...
	struct VisitorPrint {
		...
		//virtual std::stringstream visit(class ProceduresDecl*ast, int deep) = 0;
	...
	struct VisitorGraphviz {
		...
		//virtual std::stringstream visit(class ProceduresDecl*ast, std::string parent) = 0;
	};
	...
	struct VisitorInterpreter {
		...
		//virtual float visit(class ProceduresDecl*ast) = 0;
	};
	...
	struct VisitorSymbolsTable {
		...
		//virtual void visit(class ProceduresDecl*ast) = 0;
	};
	...
	struct ProcedureDecl: public AST {
		...
		Block * block;
		int number;
		ProcedureDecl(Id * id, Block * block): id(id), block(block), number(++counter){}
		std::stringstream handler(VisitorPrint * v, int deep){
			return v->visit(this, deep);
		}
		std::stringstream handler(VisitorGraphviz * v, std::string parent){
